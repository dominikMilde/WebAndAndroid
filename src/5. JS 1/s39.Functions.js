...
console.log("Array [1,2,3,4] after call to changeArray with the double function as parameter. Result: " + doubleArray);
let squareArray = changeArray([1,2,3,4], square);
console.log("Array [1,2,3,4] after call to changeArray with the square function as parameter. Result: " + squareArray);

let doubleArrayAnn = changeArray([1,2,3,4], 
  function(value) {
    return value*2;
  }
);
console.log("Array [1,2,3,4] after call to changeArray with the _anonymous_ double function as parameter. Result: " + doubleArrayAnn);
let squareArrayAnn = changeArray([1,2,3,4], function(value) {return value**2;});
console.log("Array [1,2,3,4] after call to changeArray with the _anonymous_ square function as parameter. Result: " + squareArrayAnn);
